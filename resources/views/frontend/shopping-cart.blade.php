              ...
              <tfoot>
                <tr class="first last">
                  <td colspan="50" class="a-right last">
                    <button type="button" title="Continue Shopping" class="button btn-continue" onClick="">
                      <span>
                ...
                <tr class="first last odd">
                  <td class="image hidden-table">
                    <a href="product-detail.html" title="Women&#39;s Georgette Animal Print" class="product-image">
                      <img src="{{ asset('public/front/images/speakers.png') }}" width="75" alt="Women&#39;s Georgette Animal Print">
                    </a>
                  </td>
                  <td>
                ...
                <div class="shipping-form">
                  <form action="" method="post" id="shipping-zip-form">
                    ...
                    <div class="buttons-set11">
                      <button type="button" title="Get a Quote" onClick="coShippingMethodForm.submit()" class="button get-quote">
            ...
            <div class="col-sm-4">
              <div class="discount">
                ...
                <form id="discount-coupon-form" action="" method="post">
                  ...
                  <button type="button" title="Apply Coupon" class="button coupon " onClick="discountForm.submit(false)" value="Apply Coupon">
            ...
            <div class="col-sm-4">
              <div class="totals">
                ...
                <div class="inner">
                  ...
                  <ul class="checkout">
                    <li>
                      <button type="button" title="Proceed to Checkout" class="button btn-proceed-checkout" onClick="">
                        <span>Proceed to Checkout</span>
                      </button>
                    </li>
                    <br>
                    <li>
                      <a href="multiple-addresses.html" title="Checkout with Multiple Addresses">Checkout with Multiple Addresses</a>
                    </li>
                    <br>
                  </ul>
                </div>
