					...
					<div class="row justify-content-end">
        				<div class="col-md-3 col-sm-4 col-xs-12 col-md-offset-3">
        					<div class="position-relative">
        						<h3>New 2019 Audi A6 2.0</h3>
        						<img class="img-fluid" src="{{ asset('public/front/images/slide-audi.jpg')}}" alt="image">
        						<div class="b-compare-price"><div class="b-compare__images-item-price-vs">vs</div>$90,600</div>
        					</div>
        				</div>
        				<div class="col-md-3 col-sm-4 col-xs-12 ">
        					<div class="position-relative">
        						<h3>2019 Porsche Cayenne</h3>
        						<img class="img-fluid" src="{{ asset('public/front/images/slide-porsche.jpg')}}" alt="image">
        						<div class="b-compare-price"><div class="b-compare__images-item-price-vs">vs</div>$52,650</div>
        					</div>
        				</div>
        				<div class="col-md-3 col-sm-4 col-xs-12">
        					<div class="position-relative">
        						<h3>Hyundai EON 2019</h3>
        						<img class="img-fluid" src="{{ asset('public/front/images/slide-EON.jpg')}}" alt="image">
        						<div class="b-compare-price"><div class="b-compare__images-item-price-vs">vs</div>$120,440</div>
        					</div>
        				</div>
        			</div>
				</div>    
   <div class="b-compare-block">
   <h2 style="background: #50b2fc;">Basic Information</h2>
						<div class="row">
