      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category1601"> <strong>Dealer Login Page</strong> </li>
          </ul>
        </div>
        <!--col-xs-12--> 
      </div>
  ...
  <div class="col-4 mx-auto">
    <div class="account-login">
        <div class="card-body p-4">
          <!--page-title-->
          <form action="{{ route('logindealercheck') }}" method="post" id="login-form">
              @csrf
            ...
            <fieldset class="col2-set">
              <div class="registered-users">
                ...
                <div class="content">
                  ...
                  <ul class="form-list">
                    <li>
                      <label for="email">Dealer Login Id <em class="required">*</em>
                      </label>
                      <div class="input-box">
                        <input type="text" name="loginid" value="" id="loginid" class="input-text" required title="Login id">
                      </div>
                    </li>
                    <li>
                  ...
                  <div class="buttons-set">
                    ...
                    <a href="{{ route('dealerRegister') }}" class="forgot-word">Register new dealer</a>
                  </div>
                  <!--buttons-set-->
                </div>
                <!--content-->
