...
<div class="popup1" style="display: block;">
  <div class="newsletter-sign-box">
    <h3>Newsletter Sign up</h3>
     <img src="{{ asset('public/front/images/close-icon.png')}}" alt="close" class="x" onClick="HideMe();">
    <div class="newsletter">
      <div class="newsletter_img"> <img alt="newsletter" src="{{ asset('public/front/images/newsletter_img.png')}}"></div>
