                    ...
                    <div class="container-fluid">
                        <div class="content-wrapper-content">
                            <div class="d-md-flex align-items-center mb-3 justify-content-center justify-content-lg-start">
                                <div class="main_heading"><h5>Listings</h5></div>
                                <a href="{{ route('create-listing') }}" class="btn ml-auto btn-next"><i class="fa fa-plus mr-2"></i> Add Listing</a>
                            </div>
...
<script>
    $(document).ready(function() {
      ...
      setTimeout(function(){
        var category = {{ request()->route('id') }};
        $('.datatable').DataTable({
            processing: false,
            serverSide: true,
            ajax: '/listings/datatables/'+category,
            columns: [
